...
const timezoneInput = query('.timezone-input')
const timezoneReset = query('.timezone-reset')
const timezoneSpan = query('.timezone-span')
const streamElementsCurTimeCheck = query('.stream-elements-cur-time-check')